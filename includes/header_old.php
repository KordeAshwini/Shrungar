            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <button style="background-color: #b0b435; 
                        ...
                        <a href="login.php" style="text-decoration: none; color: white; display: block; height: 100%; width: 100%;">Login</a>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="attr-nav">
                    ...
                    ?>
					<li><a href="cart.php"><i class="fa fa-shopping-bag"></i> My Cart <span class="badge"> <?php echo $count; ?> </span></a></li>
                    </ul>
                </div>
