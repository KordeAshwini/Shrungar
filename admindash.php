      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="row">
            ...
            <!-- Sales Card -->
            <!--S<div class="col-xxl-4 col-md-6">
                  ...
                  <script>
                    document.addEventListener("DOMContentLoaded", () => {
                      echarts.init(document.querySelector("#verticalBarChart")).setOption({
                        ...
                        series: [{
                            name: 'Business logins',
                            type: 'bar',
                            data: [118203, 63489, 229034, 404970, 231744, 530230]
                          },
                          {
                            name: 'Customer logins',
                            type: 'bar',
                            data: [119325, 23438, 231000, 421594, 334141, 681807]
                          }
                        ]
                      });
                    });
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="card-body pb-0">
                <h5 class="card-title">Website Traffic <span></span></h5>
